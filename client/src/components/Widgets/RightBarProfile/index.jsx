...
export default function RightBar({ user }) {
    ...
    const [followed, setFollowed] = useState(
        currentUser ? !currentUser.followings.includes(user._id) : true
    );
            ...
            <>
                {user.username !== currentUser.username && (
                    <div className="flex space-x-2">
                        ...
                        <button className="FollowBtn" style={{ backgroundColor: "red" }} onClick={handleUnFollow}>UnFollow <Remove /></button>
